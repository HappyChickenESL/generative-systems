...
Das nächste Problem war dann jedoch bei dem Laden der Textur von dem Webcam Video und das schicken dieser an die Grafikkarte. Ich habs bisher immer noch nicht hinbekommen und das stört mich sehr. Deshalb konnte ich die meisten coolen Shader, die ich vor hatte, gar nicht realisieren können...

Dort scheint es irgendein Problem mit Der Kamera und dem Schicken der Textur an die Grafikkarte zu geben, da dies als bytestream geschehen muss (mein Verständnis).
